...
#models
from users.models import User, Sexo, TipoProfesor, Pais
from utils.forms import FormBase, FormBaseUser, deshabilitar_campo
from utils.funciones import generar_username
from utils.validators import SoloLetras
...
class DocenteForm(FormBaseUser):
    nombres = forms.CharField(label=u'Nombres', max_length=100, required=True,
                              widget=forms.TextInput(attrs={'col': '6', 'placeholder':'Ingrese los nombres del docente','class':'soloLetrasET'}))
    apellido1 = forms.CharField(label=u"Primer apellido", max_length=50, required=True,
                                widget=forms.TextInput(attrs={'col': '6', 'placeholder':'Ingrese el primer apellido del docente', 'class':'soloLetrasET'}))
    apellido2 = forms.CharField(label=u"Segundo apellido", max_length=50, required=True,
                                widget=forms.TextInput(attrs={'col': '6', 'placeholder':'Ingrese el segundo apellido del docente', 'class':'soloLetrasET'}))
    cedula = forms.CharField(label=u"Cédula", max_length=10, required=False,
                             widget=forms.TextInput(attrs={'col': '6', 'placeholder':'Ingrese la cédula del docente','class':'soloNumeros'}))
    ...
    pasaporte = forms.CharField(label=u"Pasaporte", max_length=13, required=False,
                             widget=forms.TextInput(attrs={'col': '6', 'placeholder':'Ingrese el pasaporte del docente'}))
    celular = forms.CharField(label=u"Teléfono celular", max_length=50, required=True,
                               widget=forms.TextInput(attrs={'col': '6', 'placeholder': 'Ingrese el teléfono celular del docente','class':'soloNumeros'}))
    telefono = forms.CharField(label=u"Teléfono", max_length=50, required=False,
                               widget=forms.TextInput(attrs={'col': '6','placeholder':'Ingrese el teléfono del docente (opcional)','class':'soloNumeros'}))
    email = forms.CharField(label=u"Correo electrónico", max_length=200, required=True,
                            widget=forms.EmailInput(attrs={'col': '6','placeholder':'Ingrese el correo electrónico del docente'}))
    ...
    nacionalidad = forms.ModelChoiceField(label=u'Nacionalidad', required=False,
                                          ...
                                          widget=forms.Select(attrs={'col': '6'}))
    tipoprofesor = forms.ModelChoiceField(label=u"Tipo Profesor", required=True,
...
class AdministrativoForm(FormBaseUser):
    nombres = forms.CharField(label=u'Nombres', max_length=100, required=True,
